...
(function ($, window, undefined) {
    ...
    $.StackSlider.prototype = {
        ...
        _layout: function () {
            ...
            // main wrapper
            this.$wrapper = $('<div class="st-wrapper" id="st-wrapper"></div>');
            ...
            $items.each(function () {
                var $this = $(this);
                html += '<div class="st-item" data-panel="panel-1" data-title="' + $this.children('div.st-title').html() + '">' + $this.children('div.st-item').html() + '</div>';
            });
